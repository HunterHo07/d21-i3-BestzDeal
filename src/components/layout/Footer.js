  ...
  return (
    <footer ref={footerRef} className="bg-gray-900 text-white pt-16 pb-8 relative overflow-hidden">
      ...
      >
        <path
          ref={lineRef}
          d="M0,0 C240,7 480,10 720,8 C960,6 1200,0 1440,2 C1680,4 1920,8 1920,8"
          stroke="url(#footerLineGradient)"
          strokeWidth="2"
        />
        <defs>
          <linearGradient id="footerLineGradient" x1="0" y1="0" x2="1" y2="0">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="footer-item md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              The AI-powered reverse marketplace where sellers compete to offer you the best deals.
            </p>
          ...
          <div className="footer-item md:col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">info@bestzdeal.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-gray-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Copyright */}
        <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400 text-sm footer-item">
